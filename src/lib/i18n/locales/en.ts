const en: Record<string, string> = {
  ...
  "register.unsupported_stage": "This homeserver requires a verification stage Tamarix does not support yet: {{stage}}",
  ...
  "account.email_verification_sent": "Verification email sent. Complete the email verification, then confirm binding.",
  ...
  "account.identifier_visible": "This identifier is managed by the homeserver and is not written to task rooms.",
  ...
  "integrations.subtitle": "Manage external connections and webhooks through the Application Service",
