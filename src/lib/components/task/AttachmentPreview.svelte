<script lang="ts">
	...
	let IconComponent = $derived(isImage ? Image : isVideo ? Film : isAudio ? Music : FileIcon);
</script>

<div
	class="group relative flex items-center gap-3 rounded-lg border border-border bg-card p-2 transition-colors hover:bg-accent/50"
>
	<!-- Thumbnail / Icon -->
