...
export function useTaskFilters(
  ...
  return {
    ...
    get filterPriorities() { return filterPriorities; },
    set filterPriorities(v: Set<Priority>) { filterPriorities = v; },
    get filterTypes() { return filterTypes; },
    set filterTypes(v: Set<TaskType>) { filterTypes = v; },
    get filterAssignees() { return filterAssignees; },
    set filterAssignees(v: Set<string>) { filterAssignees = v; },
    get filterTags() { return filterTags; },
    set filterTags(v: Set<string>) { filterTags = v; },
    get showArchived() { return showArchived; },
    set showArchived(v: boolean) { showArchived = v; },
    get sortKey() { return sortKey; },
    set sortKey(v: SortKey) { sortKey = v; },
    get sortDir() { return sortDir; },
    set sortDir(v: "asc" | "desc") { sortDir = v; },
    get filteredTasks() { return filteredTasks; },
    get sortedTasks() { return sortedTasks; },
    toggleSort,
