...
| P2 进度 | P2 已完成 -- i18n/编号/工作流/搜索/关联/历史 + 通知系统/项目管理UI/工时/批量操作/富文本描述/移动端适配/仪表盘增强/附件删除/任务关注/端到端加密(E2EE) 全部实现 |
...
| P2 - 智能化+核心功能 | 4-6 周 | i18n/编号/工作流/搜索/关联/历史 + 通知系统/项目管理UI/工时/批量操作/富文本描述/移动端适配/仪表盘增强/附件删除/任务关注/端到端加密(E2EE) |
